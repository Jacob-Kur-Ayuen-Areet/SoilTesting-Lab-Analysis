...
if (!function_exists('generate_lab_number')) {
    ...
    {
        // Get the last generated lab number from the database, e.g., 'AA001'
        $lastLabNumber = SoilSample::max('laboratory_number');

        if (!$lastLabNumber) {
            // If no lab numbers are generated yet, start with 'AA001'
            $nextLabNumber = 'AA001';
        } else {
            ...
            if ($nextNumericPart === '999') {
                // If the numeric part reaches '999', increment the prefix letters
