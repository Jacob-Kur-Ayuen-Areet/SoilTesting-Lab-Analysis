    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="number_of_samples" value=""
                    name="number_of_samples" required>
            </div>
            <div class="form-group">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <select type="checkbox" class="form-control" id="farm_id" name="farm_id" onchange="farm_selected(this.value)" required>
