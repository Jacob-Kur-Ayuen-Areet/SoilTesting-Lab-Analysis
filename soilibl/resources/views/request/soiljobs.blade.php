                                        ...
                                        <div class="form-step" id="step-1">
                                            ...
                                            <div class="row">
                                                <input type="text" class="form-control" id="request_id" name="request_id"
                                                    value="{{ $farmer_request->request_id }}" hidden>
                                        ...
                                        <div class="form-step" id="step-3">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="crop_to_be_irrigated">Crop to be irrigated</label>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('recommendation.create', $sample->sample_id ?? '') }}">Recommenation
                                                    Results</a>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="card mt-1 mb-0 shadow-none border">
                            <div class="p-2">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0">
                                        <a href="{{ route('soil_sample_results.generatePdf', $farmer_request->request_id ?? '') }}"
                                            class="text-muted fw-bold">Download The Samples and Soil Analysis Result
                                            Sheet</a>
