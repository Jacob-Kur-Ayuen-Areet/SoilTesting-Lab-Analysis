...
class SoilSampleResult extends Model
{
    ...
    protected $fillable = [ 'request_id', 'sample_id', 'laboratory_number', 'lab_user_id','texturemethod','phosphorousmethods','micronutrientsmethods','exchangeablemethods','phmethod','dilutionratio', 'ph_cacl2', 'colour', 'texture', 'percentage_sand', 'percentage_silt', 'percentage_clay', 'min_initial_n', 'p2o5_ppm', 'k', 'mg', 'ca', 'zn', 'cu', 'mn','fe','approved', 'approved_by_user_id', 'ai_analysis', 'ai_analysis_status', 'created_at', 'updated_at'];
