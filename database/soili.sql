...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2023 at 08:26 AM
...
CREATE TABLE `farmer_requests` (
  ...
  `ica_locality` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `recommendations` (`reco_id`, `request_id`, `partner_id`, `file_path`, `approved`, `notes`, `uploaded_date`, `created_at`, `updated_at`) VALUES
(14, 27, 1, 'uploads/recommendationfiles/27.pdf', 'Y', 'wowwww', '2023-07-23 14:12:36', '2023-07-23 12:12:36', '2023-07-24 08:49:51'),
(15, 15, 1, 'uploads/recommendationfiles/15.pdf', 'Y', NULL, '2023-07-23 15:07:39', '2023-07-23 13:07:39', '2023-07-23 14:18:17'),
(16, 16, 1, 'uploads/recommendationfiles/16.pdf', 'Y', 'yey', '2023-07-23 17:01:33', '2023-07-23 15:01:33', '2023-07-23 15:01:40'),
(17, 31, 1, 'uploads/recommendationfiles/31.pdf', 'Y', 'Woe wow', '2023-07-25 14:14:54', '2023-07-25 12:14:54', '2023-07-25 12:15:45');
...
CREATE TABLE `roles` (
  ...
  `user_type` enum('Admin','Farmer','Staff','Staff_Admin','Partner') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `soil_samples` (
  ...
  `request_id` bigint(20) UNSIGNED NOT NULL,
  `laboratory_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `plot_id` bigint(20) UNSIGNED NOT NULL,
  `sample_reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_of_previous_crop` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_of_ploughing` date DEFAULT NULL,
  `date_planted` date DEFAULT NULL,
  `previous_crop_yield` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `crop` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `crop_to_be_irrigated` enum('Y','N') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `planting_date` date DEFAULT NULL,
  `plant_pop_per_ha` int(11) DEFAULT NULL,
  `yield_target_kg_per_ha` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `land_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `manure_to_be_used` enum('Y','N') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fertilizer_to_be_used` enum('Y','N') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(22, 1, 'AB00009', 1, '876', 'utut', '2023-07-21', '2023-07-13', '90', 'hggh', 'N', '2023-07-06', 9, '09', '09', 'N', 'N', '-17.831414225320998', '31.044276198766585', '2023-07-21 20:07:27', '2023-07-21 20:07:27'),
(23, 1, 'AB00010', 1, '78', 'utut', '2023-07-28', '2023-07-07', '90', 'hggh', 'N', '2023-07-13', 90, '99', '99', 'N', 'N', '-17.831414225320998', '31.044276198766585', '2023-07-21 20:12:43', '2023-07-21 20:12:43'),
...
(1, 0, 'terry tinashe gomera', '', 782879772, 'terrytinashe24@gmail.com', NULL, '$2y$10$4mvY9ur8YaUC/mvghMrXw.0mvzWOzDGgDzOpGrKITCvmRaXCNhAgC', NULL, '2023-07-12 09:36:14', '2023-07-12 09:36:14'),
...
(13, 0, 'name', '', 4, 'test@gmail.com', NULL, '$2y$10$vsldSCUBkVstRy8pkrDjBuyGi/bFNkt9w4YbXDtba6U09zYHkSwaS', NULL, '2023-07-25 07:05:44', '2023-07-25 07:05:44'),
...
--
ALTER TABLE `farmers`
  MODIFY `farmer_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `farmer_requests`
--
ALTER TABLE `farmer_requests`
  MODIFY `request_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `farms`
--
ALTER TABLE `farms`
  MODIFY `farm_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `recommendations`
  MODIFY `reco_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `soil_samples`
  MODIFY `sample_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `farmers`
  ADD CONSTRAINT `farmers_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`city_id`),
  ADD CONSTRAINT `farmers_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`),
  ADD CONSTRAINT `farmers_district_id_foreign` FOREIGN KEY (`district_id`) REFERENCES `districts` (`district_id`),
  ADD CONSTRAINT `farmers_province_id_foreign` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`province_id`),
  ADD CONSTRAINT `farmers_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `farms`
  ADD CONSTRAINT `farms_farmer_id_foreign` FOREIGN KEY (`farmer_id`) REFERENCES `farmers` (`farmer_id`);
...
--
ALTER TABLE `plot`
  ADD CONSTRAINT `plot_farm_id_foreign` FOREIGN KEY (`farm_id`) REFERENCES `farms` (`farm_id`);

--
-- Constraints for table `provinces`
--
ALTER TABLE `provinces`
  ADD CONSTRAINT `provinces_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`);

--
-- Constraints for table `recommendations`
--
ALTER TABLE `recommendations`
  ADD CONSTRAINT `recommendations_partner_id_foreign` FOREIGN KEY (`partner_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `recommendations_request_id_foreign` FOREIGN KEY (`request_id`) REFERENCES `farmer_requests` (`request_id`);

--
-- Constraints for table `soil_samples`
--
ALTER TABLE `soil_samples`
  ADD CONSTRAINT `soil_samples_plot_id_foreign` FOREIGN KEY (`plot_id`) REFERENCES `plot` (`plot_id`),
  ADD CONSTRAINT `soil_samples_request_id_foreign` FOREIGN KEY (`request_id`) REFERENCES `farmer_requests` (`request_id`);

--
-- Constraints for table `soil_sample_results`
--
ALTER TABLE `soil_sample_results`
  ADD CONSTRAINT `soil_sample_results_approved_by_user_id_foreign` FOREIGN KEY (`approved_by_user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `soil_sample_results_lab_user_id_foreign` FOREIGN KEY (`lab_user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `soil_sample_results_request_id_foreign` FOREIGN KEY (`request_id`) REFERENCES `farmer_requests` (`request_id`),
  ADD CONSTRAINT `soil_sample_results_sample_id_foreign` FOREIGN KEY (`sample_id`) REFERENCES `soil_samples` (`sample_id`);
